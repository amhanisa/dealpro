    ...
    <div class="container mx-auto">
        ...
        <div class="flex flex-col-reverse justify-between md:flex-row mt-10">
            ...
            <div class="flex flex-col space-y-4">
                <div class="flex justify-between md:justify-end md:space-x-10">
                    <div class="flex flex-col space-y-4 md:flex-row md:space-x-10 md:space-y-0">
                        <div class="">
                            <span
                ...
                <div>
                    <span
                        class="block tracking-widest uppercase font-bold text-xs text-center md:text-right text-white">Visit
                        Us
                    </span>
                    <ul class="flex justify-between mt-3 md:mt-3">
                        <li>
